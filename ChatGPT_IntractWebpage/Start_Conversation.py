...
Imagine you are a supervisor needing to ask a question based on the contents of an attached file. Your goal is to gather information from another AI without directly using the file's content, ensuring the response is primarily generated by the other AI.
...
**Steps to Follow:**
   ...
   Remember, the attached file is for your reference and supervision purposes only. Do not use the information in the file directly in your question.
